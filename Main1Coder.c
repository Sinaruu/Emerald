...
emerald_intg main1Coder(emerald_intg argc, emerald_strg* argv) {
	...
	emerald_strg operation = "";
	emerald_strg inputFileName = "";
	emerald_strg key = STR_LANGNAME;
	emerald_strg outputFileName = "";
	if (argc > 4) {
		operation = argv[2];
		...
		emerald_intg size = getSizeOfFile(outputFileName);
		emerald_strg output;
		if (atoi(operation) == CYPHER)
